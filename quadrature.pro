...
; Assign N abscissa and weights for integration on the interval [-1,1] for a variety of quadrature types
; S Simpson's
; T Trapezium
; G Gaussian
; R Radau
...
; GET 10 Jun 2005 : Fixed Trapezium quadrature (it was providing results
