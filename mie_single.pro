...
;                   algorithm
;       silent:     If set all warning messages issued by the code will
;                   be supressed.
;       mthread:    Controls the number of threads which will be
;                   utilised by the DLM version of the algorithm.
...
;
; WARNING! :
;                   The backscatter efficiency differs by 4 pi from the
;                   standard definition. The user is directed to Bohren
;                   and Huffman - Absorption and Scattering of Light by
;                   Small Particles (Wiley-VCH 1983) - Sec 4.6: "Radar
